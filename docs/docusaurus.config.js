...
const config = {
  ...
  plugins: [
    [
      ...
      {
        redirects: [
          { from: '/docs/cli', to: '/docs/using-ludus/cli' },
          { from: '/docs/blueprints', to: '/docs/using-ludus/blueprints' },
          { from: '/docs/templates', to: '/docs/using-ludus/templates' },
          { from: '/docs/snapshots', to: '/docs/using-ludus/snapshots' },
          { from: '/docs/roles', to: '/docs/using-ludus/roles' },
          { from: '/docs/tags', to: '/docs/using-ludus/tags' },
          { from: '/docs/sharing', to: '/docs/using-ludus/sharing' },
          { from: '/docs/file-share', to: '/docs/using-ludus/file-share' },
          { from: '/docs/passwords', to: '/docs/using-ludus/passwords' },
          { from: '/docs/cluster', to: '/docs/infrastructure-operations/cluster' },
          { from: '/docs/storage', to: '/docs/infrastructure-operations/storage' },
          { from: '/docs/networking', to: '/docs/infrastructure-operations/networking' },
          { from: '/docs/DNS', to: '/docs/infrastructure-operations/DNS' },
          { from: '/docs/nexus-cache', to: '/docs/infrastructure-operations/nexus-cache' },
          { from: '/docs/updating', to: '/docs/infrastructure-operations/updating' },
          { from: '/docs/admin', to: '/docs/administration/admin' },
          { from: '/docs/security', to: '/docs/administration/security' },
          { from: '/docs/sso', to: '/docs/administration/sso' },
        ],
      },
    ],
  ],
