...
| [5tuk0v.ludus_ghostwritter](https://github.com/5tuk0v/ludus_ghostwriter) | Installs [Ghostwriter](https://github.com/GhostManager/Ghostwriter) on a Linux-based host using ghostwriter-cli and Docker Compose. | [@stuk0v_](https://x.com/stuk0v_) |
...
| [e1a.ludus_windows_smb_share](https://github.com/E1A/ludus_windows_smb_share) | An Ansible Role that creates a Windows SMB share and configures both share permissions and NTFS ACLs for read and write groups | [E1A](https://x.com/7hreathunter) | |