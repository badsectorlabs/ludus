...
| [badsectorlabs.ludus_commandovm](https://github.com/badsectorlabs/ludus_commandovm) | Sets up Commando VM on Windows >= 10 hosts | Bad Sector Labs | Available as a [template](https://github.com/badsectorlabs/ludus-source-bsl/tree/main/templates/commando-vm) |
| [badsectorlabs.ludus_flarevm](https://github.com/badsectorlabs/ludus_flarevm) | Installs Flare VM on Windows >= 10 hosts | Bad Sector Labs | Available as a [template](https://github.com/badsectorlabs/ludus-source-bsl/tree/main/templates/flare-vm) |
| [badsectorlabs.ludus_remnux](https://github.com/badsectorlabs/ludus_remnux) | Installs REMnux on Ubuntu 20.04 systems | Bad Sector Labs | Available as a [template](https://github.com/badsectorlabs/ludus-source-bsl/tree/main/templates/remnux) |
...
| [jasonmull.ludus_ghosts_client](https://github.com/jasonmull/ludus_ghosts_client) | Installs [Ghosts](https://github.com/cmu-sei/GHOSTS) client on a Windows endpoint | [@jasonmull](https://github.com/jasonmull) | |
| [jasonmull.empire_c2_docker](https://github.com/jasonmull/empire_docker_ansible) | Deploy [Empire C2](https://github.com/BC-SECURITY/Empire) via Docker | [@jasonmull](https://github.com/jasonmull) | |
...
| [netpenguins.ludus_k3s](https://github.com/NetPenguins/ludus_k3s) | Deploys a [k3s](https://docs.k3s.io/) cluster in ludus ranges | [NetPenguins](https://github.com/NetPenguins) ||
| [ludus_enable_asr](https://github.com/curi0usJack/Ludus-MDE-MDI-Roles/tree/main/ludus_enable_asr) | Enables many Attack Surface Reduction rules on a Windows host | [Jason Lang @curi0usJack](https://x.com/curi0usJack) | Must install from directory |
| [ludus_enable_mdi_gpo](https://github.com/curi0usJack/Ludus-MDE-MDI-Roles/tree/main/ludus_enable_mdi_gpo) | Uses Set-MDIConfiguration to create GPOs and add the recommended auditing settings for a Microsoft Defender for Identity rollout on a Windows host | [Jason Lang @curi0usJack](https://x.com/curi0usJack) | Must install from directory |
| [ludus_badblood](https://github.com/curi0usJack/ludus_badblood) | Outfits your ludus AD domain with BadBlood info | [Jason Lang @curi0usJack](https://x.com/curi0usJack) | Must install from directory |
| [ludus_splunk_universalforwarder](https://github.com/curi0usJack/ludus_splunk_universalforwarder) | Installs Splunk Universal Forwarder on Windows endpoints for Ludus ranges. | [Jason Lang @curi0usJack](https://x.com/curi0usJack) | Must install from directory |
| [ludus_splunk](https://github.com/curi0usJack/ludus_splunk) | Installs Splunk Enterprise on Linux for Ludus ranges. | [Jason Lang @curi0usJack](https://x.com/curi0usJack) | Must install from directory |
| [ludus_adtimeline_syncthing](https://github.com/mojeda101/ludus_adtimeline_syncthing) | Installs [ADTimeline](https://splunkbase.splunk.com/app/4897) Splunk app in a Splunk Docker Container and to sync the automatic ingestion folder additionally Syncthing is added. | [mojeda101](https://github.com/mojeda101) |
| [ludus_litterbox](https://github.com/professor-moody/ludus_litterbox_role) | Installs [Litterbox](https://github.com/BlackSnufkin/LitterBox) controlled sandbox environment designed for security professionals to develop and test payloads. | [professor-moody](https://github.com/professor-moody) |
| [professor_moody.scorch.ludus](https://github.com/professor-moody/ludus_scorch) | Sets up a full SCORCH (System Center Orchestrator) deployment with various common misconfigurations. | [professor-moody](https://galaxy.ansible.com/ui/repo/published/professor_moody/ludus_scorch/) collection |
| [5tuk0v.ludus_wsus](https://github.com/5tuk0v/ludus_wsus) | Installs Windows Server Update Services (WSUS) on Windows Server and optionally configures products, classifications, and synchronization schedules. | [@stuk0v_](https://x.com/stuk0v_) |
| [5tuk0v.ludus_vectr](https://github.com/5tuk0v/ludus_vectr) | Installs [VECTR](https://github.com/SecurityRiskAdvisors/VECTR), a threat tracking and campaign management tool, on Ubuntu 22.04 LTS using Docker Compose. | [@stuk0v_](https://x.com/stuk0v_) |
| [5tuk0v.ludus_ghostwriter](https://github.com/5tuk0v/ludus_ghostwriter) | Installs [Ghostwriter](https://github.com/GhostManager/Ghostwriter) on a Linux-based host using ghostwriter-cli and Docker Compose. | [@stuk0v_](https://x.com/stuk0v_) |
| [5tuk0v.ludus_zeek](https://github.com/5tuk0v/ludus_zeek/) | Installs [Zeek](https://github.com/zeek/zeek) on Debian and Ubuntu hosts. | [@stuk0v_](https://x.com/stuk0v_) |
| [inf0junki3.ludus.netbox](https://galaxy.ansible.com/ui/repo/published/inf0junki3/ludus/content/role/netbox/) | Sets up the Netbox network & infrastructure management solution. | [inf0junki3](https://github.com/Inf0Junki3) | Part of the [inf0junki3.ludus](https://galaxy.ansible.com/ui/repo/published/inf0junki3/ludus/docs/) collection | 
| [inf0junki3.ludus.vectr](https://galaxy.ansible.com/ui/repo/published/inf0junki3/ludus/content/role/vectr/) | Sets up the VECTR red/purple team platform | [inf0junki3](https://github.com/Inf0Junki3) | Part of the [inf0junki3.ludus](https://galaxy.ansible.com/ui/repo/published/inf0junki3/ludus/docs/) collection | 
| [brmkit.ludus_nemesis](https://github.com/brmkit/ludus_nemesis) | Installs [Nemesis](https://github.com/SpecterOps/Nemesis) by SpecterOps | [@_brmkit](https://x.com/_brmkit) | |
...
| [bu5h-d.ludus_kubernetes_goat](https://github.com/bu5h-d/ludus_kubernetes_goat) | Installs [Kubernetes Goat](https://github.com/madhuakula/kubernetes-goat) on a Debian based Ludus VM using k3s and Helm | [bu5h](https://github.com/bu5h-d) ||