...
+------------+-----------------------------------+-------+-------------+
|    107     | JD-router-debian13-x64            |  On   | 10.2.10.254 |
...
Want to share this range with others or spin up a different range in addition to this one? Check out [range sharing](../using-ludus/sharing).
