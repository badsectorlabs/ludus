 ...
 * Ludus API
 *
 * This API controls Ludus user management, range deployment, power state, and testing state.
 *
 * API version: 1.0.0
...
func NewRouter(ludusVersion string) *gin.Engine {
...
func Index(c *gin.Context) {
	c.JSON(http.StatusOK, gin.H{"result": fmt.Sprintf("Ludus Server v%s", LudusVersion)})
}
