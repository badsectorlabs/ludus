variable "iso_checksum" {
  type    = string
  default = "sha256:06019fd7c4f956b2b0ed37393e81c577885e4ebd518add249769846711a09dc4"
}
...
variable "iso_url" {
  type    = string
  default = "https://download.rockylinux.org/pub/rocky/8/isos/x86_64/Rocky-8.9-x86_64-minimal.iso"
}
